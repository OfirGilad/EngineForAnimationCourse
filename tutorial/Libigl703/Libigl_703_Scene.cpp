...
void Libigl_703_Scene::Init(float fov, int width, int height, float near, float far)
{
...
void Libigl_703_Scene::Update(const Program& program, const Eigen::Matrix4f& proj, const Eigen::Matrix4f& view, const Eigen::Matrix4f& model)
{
